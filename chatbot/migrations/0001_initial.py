# Generated by Django 5.2.5 on 2025-08-31 00:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('user', 'User')], default='user', help_text='User role determines access level', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sql', models.TextField(help_text='Generated SQL query')),
                ('answer', models.TextField(help_text='Response provided to user')),
